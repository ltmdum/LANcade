...
export interface CategoryClash2GameOptions {
  onStateChange?: () => void;
  clientGraceMs?: number;
  playerStore?: PlayerStore;
}

export interface CategoryClash2Game extends CategoryClashEngine {
  id: string;
  name: string;
  categories: string[];
}
 ...
 */
export function createGame(options: CategoryClash2GameOptions = {}): CategoryClash2Game {
