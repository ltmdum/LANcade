...
export interface WordSprintGameOptions {
  onStateChange?: () => void;
 ...
 */
export function createGame(options: WordSprintGameOptions = {}) {
   ...
   */
  function getState(): Omit<WordSprintState, 'game' | 'games'> {
...
export type WordSprintGame = ReturnType<typeof createGame>;
