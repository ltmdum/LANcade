...
import type { WordSprintState, PlayerGameState, LetterStatus } from '@lancade/shared';
 ...
 */
function createBaseState(): WordSprintState {
  return {
    serverTime: Date.now(),
    players: [
    ...
    game: { id: 'wordsprint', name: 'Word Sprint' },
    games: [{ id: 'wordsprint', name: 'Word Sprint' }],
  };
}
 ...
 */
function createDefaultProps(serverState: WordSprintState) {
  return {
    serverState,
...
describe('WordSprintGame', () => {
  ...
  describe('idle state', () => {
    it('renders nothing when match is idle', () => {
      ...
      const { container } = render(
        <WordSprintGame {...createDefaultProps(state)} />
      );
  ...
  describe('active state', () => {
    it('renders the guess grid', () => {
      ...
      render(<WordSprintGame {...createDefaultProps(state)} />);
