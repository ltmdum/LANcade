...
import { CategoryClash1Game } from '../CategoryClash1Game';
...
function createBaseState(): CategoryClashState {
  return {
    ...
    game: { id: 'categoryclash1', name: 'Category Clash v1.0' },
    games: [{ id: 'categoryclash1', name: 'Category Clash v1.0' }],
  };
}
...
describe('CategoryClash1Game', () => {
  ...
  describe('idle state', () => {
    it('renders nothing when round is idle', () => {
      ...
      const { container } = render(
        <CategoryClash1Game {...createDefaultProps(state)} />
      );
  ...
  describe('active state', () => {
    it('renders the active panel with letter display', () => {
      ...
      render(<CategoryClash1Game {...createDefaultProps(state)} />);
  ...
  describe('voting state', () => {
    ...
    it('does not render admin controls during voting state', () => {
      ...
      render(<CategoryClash1Game {...props} />);
  ...
  describe('results state', () => {
    ...
    it('admin non-player renders nothing during active state', () => {
      ...
      const { container } = render(<CategoryClash1Game {...props} />);
