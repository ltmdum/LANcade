...
import { CategoryClash1ActivePanel } from './components/CategoryClash1ActivePanel';
...
import './CategoryClash1Game.css';

interface CategoryClash1GameProps extends GameProps {
 ...
 */
export function CategoryClash1Game({
  serverState,
  connection,
  playerId,
  playerName,
