...
function createBaseState(): CategoryClashState {
  return {
    ...
    game: { id: 'categoryclash2', name: 'Category Clash v2.0' },
    games: [{ id: 'categoryclash2', name: 'Category Clash v2.0' }],
  };
}
...
describe('CategoryClash2Game', () => {
  ...
  describe('idle state', () => {
    it('renders nothing when round is idle', () => {
      ...
      const { container } = render(
        <CategoryClash2Game {...createDefaultProps(state)} />
      );
  ...
  describe('active state', () => {
    it('renders the active panel with letter display', () => {
      ...
      render(<CategoryClash2Game {...createDefaultProps(state)} />);
